...
const IconLogo = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#64ffda" class="bi bi-hexagon" viewBox="0 0 16 16">
        ...
        <text x="4.7" y="11.5" fill="#64ffda" fontSize="10">R</text>
    </svg>
);
